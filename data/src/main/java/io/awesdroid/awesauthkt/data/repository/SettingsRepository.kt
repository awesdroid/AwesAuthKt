...
class SettingsRepository(private var context: Context?) {
    ...
    init {
        ...
        authType = MutableLiveData(
            sharedPreferences.getString(context!!.resources.getString(R.string.pref_key_google_auth_type), TYPE_NONE)
        )
       ...
       listener = SharedPreferences.OnSharedPreferenceChangeListener { sp, key ->
           ...
           when (key) {
               context!!.resources.getString(R.string.pref_key_google_auth_type) ->
